...
leResult screenShow_Home(void)
{
    ...
    Home_BackgroundPanel->fn->setSize(Home_BackgroundPanel, 480, 320);
    ...
    Home_LabelWidget_1->fn->setPosition(Home_LabelWidget_1, 93, 155);
    ...
    Home_LabelWidget_2->fn->setPosition(Home_LabelWidget_2, 69, 222);
